...
In this project:
  ...
  3) Finally, I'll (hopefully) collect some thought-provoking statistics based on the results.

The goals of this project are:
  1) To find a viable pattern that can comfortably score a 2048 tile
  2) To tackle any subproblems I come across while creating my version of the game
  3) To try my hand at small-scale, informal independent research (define problem, test, collect results)

Finally, I enjoy coding and the process of building things, so I hope to have fun!
